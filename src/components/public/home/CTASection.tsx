...
export default function CTASection() {
  return (
    <section className="relative py-20 lg:py-28 overflow-hidden" id="portal-akses">
      <div
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-white/75 mb-10 max-w-2xl mx-auto leading-relaxed">
            Login untuk masuk ke dashboard sekolah, atau buat akun baru dari portal yang sama
            dengan tampilan yang selalu mengikuti tema aktif website dan admin.
          </p>
          ...
          >
            <span className="flex items-center gap-1.5">
              ...
              Login & Register Cepat
            </span>
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-amber-400" />
              Tema Sinkron dengan Dashboard
            </span>
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-blue-400" />
              Akses Admin, Guru, dan Wali
            </span>
          </motion.div>
        </motion.div>
      </div>
