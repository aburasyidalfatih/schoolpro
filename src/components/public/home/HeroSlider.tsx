  ...
  return (
    <section className="relative h-[60vh] sm:h-[70vh] lg:h-[85vh] overflow-hidden" id="hero-slider" aria-label="Slider Utama">
      ...
      <div className="relative z-10 h-full flex items-end pb-12 sm:pb-20 lg:pb-32">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-24 xl:px-32 2xl:px-36 w-full">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="max-w-3xl lg:max-w-[42rem] xl:max-w-[46rem]"
            >
              {/* Slide counter badge */}
              <motion.div
      ...
      <button
        onClick={prev}
        className="hidden sm:flex absolute left-6 lg:left-10 xl:left-14 2xl:left-16 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-xl bg-white/10 backdrop-blur hover:bg-white/25 items-center justify-center text-white transition-all focus-visible:outline-2 focus-visible:outline-white"
      ...
      <button
        onClick={next}
        className="hidden sm:flex absolute right-6 lg:right-10 xl:right-14 2xl:right-16 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-xl bg-white/10 backdrop-blur hover:bg-white/25 items-center justify-center text-white transition-all focus-visible:outline-2 focus-visible:outline-white"
